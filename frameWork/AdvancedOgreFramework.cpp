...
// Destructeurs, nettoyage

OgreFramework::~OgreFramework()
{
    OgreFramework::getSingletonPtr()->m_pLog->logMessage("OGRE est en cours de fermeture...");
...
/*
 updateOgre(): Est appellé pour chaque frame par AppStateManager pour mettre à jour directement 
 tout ce qui à un lien avec ogre.
*/
