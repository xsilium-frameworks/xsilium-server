...
public:
	 ...
	 *  	title: Intitul� du ticket
	 *  	text: Contenu du ticket
	 *  	coord: coordon�e de l'emetteur
	 *  	idReporter: identit� de la personne envoyant le ticket
	 ...
	 *  \param messageNetwork
	 *	MessagePacket.propery:
	 *  	idTicket: num�ro de ticket
	 *		idReponsible: identit� de la personne traitant le ticket
	 *  	title: Intitul� du ticket
	 *  	text: Contenu du ticket
	 *  	category: Categorie du ticket
	 *  	subCategory: sous categorie du ticket
